...
const ModalContent = ({ onClose }) => {
    ...
    return (
        <>
            <div id="authentication-modal" tabindex="-1" aria-hidden="true" className=" flex justify-center items-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full bg-black bg-opacity-50 ">
                <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#" onSubmit={formik.handleSubmit}>
                            ...
                            <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                                Not registered? <a href="#" className="text-blue-700 hover:underline dark:text-blue-500" onClick={toggleLogin}>Create account</a>
                            </div>
                        </form>
                    </div>
                </div>
